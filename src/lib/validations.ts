...
export const PropertySchema = z.object({
  ...
  priceBnB: z.preprocess((v) => (v === "" || v === undefined ? undefined : v === null ? null : Number(v)), z.number().min(1).optional().nullable()),
  priceHalfBoard: z.preprocess((v) => (v === "" || v === undefined ? undefined : v === null ? null : Number(v)), z.number().min(1).optional().nullable()),
  priceFullBoard: z.preprocess((v) => (v === "" || v === undefined ? undefined : v === null ? null : Number(v)), z.number().min(1).optional().nullable()),
